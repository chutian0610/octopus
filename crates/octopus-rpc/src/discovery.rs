...
pub mod discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn announce(
            &mut self,
            request: impl tonic::IntoRequest<super::NodeAnnounceReq>,
        ) -> std::result::Result<
            tonic::Response<super::NodeAnnounceResp>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
/// Generated client implementations.
pub mod remote_store_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct RemoteStoreServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RemoteStoreServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> RemoteStoreServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RemoteStoreServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RemoteStoreServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn save(
            &mut self,
            request: impl tonic::IntoRequest<super::super::common::NodeMetadata>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/discovery.RemoteStoreService/Save",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("discovery.RemoteStoreService", "Save"));
            self.inner.unary(req, path, codec).await
        }
        /// Batch save a list of node metadata to remote store.
        pub async fn batch_save(
            &mut self,
            request: impl tonic::IntoRequest<super::super::common::NodeMetadataList>,
        ) -> std::result::Result<
            tonic::Response<super::RemoteStoreSaveResp>,
            tonic::Status,
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/discovery.RemoteStoreService/BatchSave",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("discovery.RemoteStoreService", "BatchSave"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn get_all(
            ...
            tonic::Response<super::super::common::NodeMetadataList>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/discovery.RemoteStoreService/GetAll",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("discovery.RemoteStoreService", "GetAll"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod discovery_service_server {
    ...
    pub trait DiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn announce(
            &self,
            request: tonic::Request<super::NodeAnnounceReq>,
        ) -> std::result::Result<
            tonic::Response<super::NodeAnnounceResp>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/discovery.DiscoveryService/Announce" => {
                    ...
                    impl<
                        T: DiscoveryService,
                    > tonic::server::UnaryService<super::NodeAnnounceReq>
                    for AnnounceSvc<T> {
                        type Response = super::NodeAnnounceResp;
...
/// Generated server implementations.
pub mod remote_store_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RemoteStoreServiceServer.
    #[async_trait]
    pub trait RemoteStoreService: std::marker::Send + std::marker::Sync + 'static {
        /// Save a node metadata to remote store.
        async fn save(
            &self,
            request: tonic::Request<super::super::common::NodeMetadata>,
        ) -> std::result::Result<
            tonic::Response<super::RemoteStoreSaveResp>,
            tonic::Status,
        >;
        ...
        async fn batch_save(
            &self,
            request: tonic::Request<super::super::common::NodeMetadataList>,
        ) -> std::result::Result<
            tonic::Response<super::RemoteStoreSaveResp>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct RemoteStoreServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> RemoteStoreServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RemoteStoreServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/discovery.RemoteStoreService/Save" => {
                    ...
                    impl<
                        T: RemoteStoreService,
                    > tonic::server::UnaryService<super::super::common::NodeMetadata>
                    for SaveSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteStoreService>::save(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/discovery.RemoteStoreService/BatchSave" => {
                    #[allow(non_camel_case_types)]
                    struct BatchSaveSvc<T: RemoteStoreService>(pub Arc<T>);
                    impl<
                        T: RemoteStoreService,
                    > tonic::server::UnaryService<super::super::common::NodeMetadataList>
                    for BatchSaveSvc<T> {
                        type Response = super::RemoteStoreSaveResp;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::super::common::NodeMetadataList,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteStoreService>::batch_save(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/discovery.RemoteStoreService/GetAll" => {
                    ...
                    for GetAllSvc<T> {
                        type Response = super::super::common::NodeMetadataList;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteStoreService>::get_all(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RemoteStoreServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "discovery.RemoteStoreService";
    impl<T> tonic::server::NamedService for RemoteStoreServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
